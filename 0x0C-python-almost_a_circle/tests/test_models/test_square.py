...
class TestSquare_Str(unittest.TestCase):
    ...
    def test_str_height_width(self):
        t = Square(5, 1)
        correct_output = "[Square] ({}) 1/0 - 5/5".format(t.id)
        self.assertEqual(correct_output, t.__str__())

    def test_str_height_width_y(self):
        t = Square(4, 6, 1)
        correct_output = "[Square] ({}) 6/1 - 4/4".format(t.id)
        self.assertEqual(correct_output, t.__str__())
    ...
    def test_str_height_width_x(self):
        t = Square(1, 5, 5)
        correct_output = "[Square] ({}) 5/5 - 1/1".format(t.id)
        self.assertEqual(correct_output, t.__str__())
...
class TestSquare_update_args(unittest.TestCase):
    ...
    def test_update_args_one_args(self):
        t = Square(10, 10, 10, 10)
        t.update(89)
        self.assertEqual("[Square] (89) 10/10 - 10/10", t.__str__())

        def test_update_two_args(self):
            t = Square(10, 10, 10, 10)
        t.update(89, 2)
        self.assertEqual("[Square] (89) 10/10 - 2/2", t.__str__())
    ...
    def test_update_four_args(self):
        t =Square(4, 10, 10, 10)
        t.update(89, 2, 3, 4)
        self.assertEqual("[Square] (89) 3/4 - 2/2", t.__str__())
    ...
    def test_update_None_args(self):
        t = Square(10, 10, 10, 10)
        t.update(None)
        correct_output = "[Square] ({}) 10/10 - 10/10".format(t.id)
        self.assertEqual(correct_output, t.__str__())
...
class TestSquare_update_kwargs(unittest.TestCase):
    def test_update_kwargs_one(self):
        t = Square(10, 10, 10, 10,)
        t.update(id=1)
        self.assertEqual("[Square] (1) 10/10 - 10/10", t.__str__())
    
    def test_update_kwargs_two (self):
        t = Square(10, 10, 10, 10)
        t.update(id=1, size=2)
        self.assertEqual("[Square] (1) 10/10 - 2/2", t.__str__())
    
    def test_update_kwargs_tree (self):
        t = Square(10, 10, 10, 10)
        t.update(id=1, size=2, x=3)
        self.assertEqual("[Square] (1) 3/10 - 2/2", t.__str__())

    def test_update_kwargs_four (self):
        t = Square(10, 10, 10, 10)
        t.update(id=1, size=2, y=3, x=4)
        self.assertEqual("[Square] (1) 4/3 - 2/2",t.__str__())

    def test_update_kwargs_morethan_five (self):
        t = Square(10, 10, 10, 10)

        t.update(id=1, x=4,y=5, i=10)
        self.assertEqual("[Square] (1) 4/5 - 10/10", t.__str__())
    ...
    def test_update_kwargs_some_wrong_keys(self):
        ...
        self.assertEqual("[Square] (89) 10/10 - 5/5", t.__str__())
